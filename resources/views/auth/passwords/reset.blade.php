...
<div class="offset-md-1 col-md-10">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('password.update')}}" method="get" accept-charset="utf-8">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="password-confirm" type="password-confirm" name="password-confirm" class="form-control{{ $errors->has('password-confirm')}}">
                    </div>
                </div>
